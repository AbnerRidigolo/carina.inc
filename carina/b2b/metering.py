...
#: a chamada do Data Engine — "SaaS por volume de chamadas" — EVALUATION é uma
#: execução do benchmark SEAL BR e BACKTEST é um backtest da Builder Layer).
